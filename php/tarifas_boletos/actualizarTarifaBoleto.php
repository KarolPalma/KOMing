...
if ($accion == "guardar") { //Si el form a pasado correctamente por las validaciones la accion se habra cambiado a guardar, sino estara vacia
    ...
    $sql = "CALL Update_Tarifa_Boleto('" . $_POST["txtNoTarifa"] . "','" . $_POST["txtDescripcion"] . "','" . $_POST["txtPrecio"] .
    ...
    echo "<script>
                window.location.href = '../../forms/tarifas_boletos/form_filtroTarifaBoleto.php';
      </script>";
...
if ($accion == "desactivar") { //Si el boton presionado fue el de desactivacion la accion sera desactivar
    ...
    $sql = "CALL Deactivate_Tarifa_Boleto('" . $_POST["txtNoTarifa"] . "','" . $_POST["usuarioLogin"] . "')";
    $resultado = mysqli_query($conexion, $sql);

<?php 
    ...
    $sql = "SELECT * FROM v_Cliente WHERE Id_Cliente = '" . $id . "';"; //Utiliza una vista en la BD creada para devolver los datos del cliente junto con su pais y ciudad (los ultimos dos mediante INNER JOIN)

...
if ($accion == "guardar") { //Si el form a pasado correctamente por las validaciones la accion se habra cambiado a guardar, sino estara vacia
    ...
    $sql = "CALL Update_Empleado('" . $_POST["txtIdentidad"] . "','" . $_POST["txtNombres"] . "','" . $_POST["txtApellidos"] ."','" . $_POST["dtefnac"] . "','" . $_POST["dtefccont"] . "','" . $_POST["dteffcont"] . "','" . $_POST["txtTelefono"] . "','" . $_POST["txtEmail"] . "','" . $_POST["cmbCargo"] . "','" . $_POST["cmbReportaA"] . "','" . $_POST["cmbGenero"] . "','" . $_POST["txtDireccion"] . "','" . $_POST["cmbTerminal"] . "','" . $_POST["usuarioLogin"] . "')";

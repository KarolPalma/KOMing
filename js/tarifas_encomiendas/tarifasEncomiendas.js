function revisarOrigenDestino() {
    ...
    //alert('Origen ' + idTerminalOrigen + " Destino " + idTerminalDestino)
    if (idTerminalOrigen == "") {
    ...
    }else if (idTerminalDestino.value != "" && idTerminalOrigen.value != "" && volumen.value != "") {
        $.ajax({
            type: 'POST',
            ...
            .done(function (respuesta) {
                if (respuesta == 1) { //Si el conteo de registros de es igual a 1, quiere decir que ya existe una tarifa con ese volumen, origen y destino
                    alert("Ya existe una tarifa de encomienda con este volumen, terminal de origen y destino");

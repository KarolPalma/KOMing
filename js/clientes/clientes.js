...
function validar() {
    ...
    } else if (document.getElementById("cmbTerminal").value == "") {
        alert("Por favor seleccione una terminal de origen");
        document.getElementById("cmbTerminal").focus();
    } else if (document.getElementById("txtTelefono").value == "") {
        alert("Favor ingrese el número de teléfono del cliente");

...
include("../../php/encomiendas/insertarEncomienda.php");
...
<head>
    ...
    <title>Vender Encomienda - KOMing</title>
    <script src="../../js/jquery-1.10.2.min.js"></script>
    <!--Libreria básica de JQuery-->
    <script src="../../js/encomiendas/encomiendas.js"></script>
    ...
    <script src="../../js/encomiendas/cargarPrecioTarifa.js"></script>
</head>
...
<body>
    <div class="container">
        <div class="col-12 text-center mt-5 mb-5">
            ...
            <h3 style="background-color: #3987E3; color: white;">Vender Encomienda</h3>
        </div>
        <form name='formulario' id='formulario' method='POST' action="">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <?php //$sql = "SELECT (COUNT(*) + 1) AS C FROM Encomiendas";
                    $sql = "SELECT (Id_Guia + 1) AS C FROM Encomiendas ORDER by Id_Guia DESC LIMIT 1";
                    $noGuia = 0;
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div class="form-group mt-2 mb-2">
                            ...
                            <input type="number" class="form-control" name="txtNoGuia" id="txtNoGuia" maxlength="45" <?php echo "value='$noGuia'" ?> readonly>
                        </div>
                    </div>
                    <!--Volumen-->
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <input type="number" class="form-control" name="txtVolumen" id="txtVolumen" maxlength="45" placeholder="Ingrese el número del volumen" <?php echo 'value="' . $_POST['txtVolumen'] . '"' ?>>
                        </div>
                    </div>
                    <!--Fecha Envio-->
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <input type="date" class="form-control" name="txtFechaEnvio" id="txtFechaEnvio" value="<?php echo date('Y-m-d'); ?>" readonly />
                        </div>
                    </div>
                    <!--Hora Envio-->
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <input type="time" class="form-control" name="txtHoraEnvio" id="txtHoraEnvio" value="<?php echo date('H:i:s', time()); ?>" readonly>
                        </div>
                    </div>
                    <!--Empleado-->
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <input type="text" class="form-control" name="txtIdEmisor" id="txtIdEmisor" placeholder="Ingrese el número de identidad del emisor" <?php echo 'value="' . $_POST['txtIdEmisor'] . '"' ?>>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <input type="text" class="form-control" name="txtIdReceptor" id="txtIdReceptor" placeholder="Ingrese el número de identidad del emisor" <?php echo 'value="' . $_POST['txtIdReceptor'] . '"' ?>>
                        </div>
                    </div>
                    <!--Fecha Filtro-->
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-3 mb-2">
                            <label class="form-label"><b>Especificaciones del Viaje</b></label>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center my-4">
                        <table id='tabla' class="table table-striped table-bordered" style="max-width: 1100px;">
                            ...
                            $volumen = isset($_POST["txtVolumen"]) ? $_POST["txtVolumen"] : "";
                            ...
                            if ($accion == "consultar" && $fecha != "") {
                                ...
                                if (mysqli_num_rows($result) != 0) { //Si la respuesta contiene por lo menos un registro, imprime la tabla
                                    ...
                                    <th scope='col' style='text-align: center;'>Volumen Disponible</th>
                                    </tr>
                                    </thead>
                                    <tbody>";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { //Imprime los registros que concuerdan con la consulta $sql
                                        ...
                                        <th scope='row' style='text-align: center;'>
                                            <input class='form-check-input' type='radio' name='checkViaje' id='checkViaje' value='" . $row["Id_Viaje"] . "'>
                                        </th>
                                        ...
                                        <td scope='row' style='text-align: center;'>" . $row["Cupos_Volumen_Encomiendas"] . "</td>
                                        </tr>";
                                    }
                                }
                                echo "</table>";
                                ...
                                $sql = "SELECT * FROM v_Viaje_Compra_Encomiendas
                                        WHERE Id_Terminal_Origen = " . $origen . " AND Id_Terminal_Destino = " . $destino . " AND Cupos_Volumen_Encomiendas >= " . $volumen;
                                $result = mysqli_query($conexion, $sql);
                                if (mysqli_num_rows($result) != 0) {
                                    echo
                                    "<thead>
                        ...
                        <div class="form-group mt-2 mb-2">
                            <?php
                                if ($accion == "consultar" && mysqli_num_rows($result) != 0) {
                                    ...
                                    $sql = "SELECT Id_Tarifa, Descripcion FROM Tarifas_Encomiendas WHERE Id_Terminal_Origen = " . $_POST["cmbTerminalOrigen"] . "
                                            AND Id_Terminal_Destino = " . $_POST["cmbTerminalDestino"] . " AND Volumen = " . $_POST["txtVolumen"] . " AND Activo = 1";
                                    $result = mysqli_query($conexion, $sql);
                                    while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    if (mysqli_num_rows($result) == 0) {
                                        echo "<option value=''>-- Sin Tarifas para este Volumen --</option>";
                                    }
                                    echo "</select>";
                                }
                            ?>

                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            if ($activo == 1) { //Si el cliente está como activo en la BD el boton será visible, si no, no
                                ...
                                echo "<button onclick='return validar()'' name='btnGuardar' id='btnGuardar' class='btn btn-primary m-5' style='background-color: #3987E3; border-color: #3987E3;'>Activar Cliente</button>";
                            }
                            ?>

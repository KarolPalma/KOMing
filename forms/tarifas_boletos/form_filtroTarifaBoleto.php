    ...
    <body>
        ...
        <div class="d-flex justify-content-center my-4">
            ...
            <table id='tabla' class="table table-striped table-bordered" style="max-width: 1100px;">
                ...
                if ($accion == "consultar") {
                    $sql = "SELECT TB.Id_Tarifa, C1.Nombre_Terminal AS Origen, C2.Nombre_Terminal AS Destino, TB.Precio
                        FROM v_Tarifas_Boletos AS TB INNER JOIN Terminales AS C1 ON TB.Id_Terminal_Origen = C1.Id_Terminal

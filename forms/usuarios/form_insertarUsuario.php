...
?>
    ...
    <head>
        ...
        <title>Insertar Usuario - KOMing</title>
    ...
    <body>
        <div class="container">
            <div class="col-12 text-center mt-5 mb-5">
                ...
                <h3 style="background-color: #3987E3; color: white;">Insertar Usuario</h3>
            </div>
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            ...
                            <div class="form-group mt-2 mb-2">
                                ...
                                <input type="txt" class="form-control" name="txtUsuario" id="txtUsuario" maxlength="45" placeholder="Ingrese el usuario a crear" value="">
                            </div>
                        </div>
                        <!--Empleado-->
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <button onClick="return revisarUsuario()" name="btnGuardar" id="btnGuardar" class="btn btn-primary m-5" style="background-color: #3987E3; border-color: #3987E3;">Guardar</button>

...
?>
    ...
    <head>
        ...
        <title>Filtro de Usuarios - KOMing</title>
        <!--Scripts-->
        <script type="text/javascript">
            function validar() {
                if (document.getElementById("txtUsuario").value == "" && document.getElementById("cmbEstado").value == '' && document.getElementById("cmbCargo").value == '') {
    ...
    <body>
        ...
        <div class="container">
            <div class="col-12 text-center mt-5 mb-5">
                <h3 style="background-color: #3987E3; color: white;">Filtrar Usuarios</h3>
            </div>
        ...
        <div class="d-flex justify-content-center my-4">
            ...
            <table id='tabla' class="table table-striped table-bordered" style="max-width: 1100px;">
                ...
                if ($accion == "consultar") {
                    ...
                    if ($cargo != '') {
                        if ($sql == "") {  
                            $sql = "SELECT * FROM v_Usuario WHERE Administrador = '$cargo' ";
                        } else {
                            $sql = $sql . " AND Administrador = '$cargo'";
                        }
                    }
                    ...
                    if (mysqli_num_rows($result) != 0) { //Si la respuesta contiene por lo menos un registro, imprime la tabla
                        ...
                        <td>" . $tipo . "</td>
                        <td>" . $estadoUsuario . "</td>
                        <td style='text-align: center'><a class='btn btn-primary' style='background-color: #3987E3; border-color: #3987E3;' href='form_actualizarUsuario.php?idUsuario=" . $row["Id_Usuario"] . "'>Actualizar</a></td>

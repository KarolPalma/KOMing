...
?>
    ...
    if ($accion == "guardar") {
        ...
        $sql = "UPDATE Usuarios SET Clave = '$contrasenia', Clave_Cambiada = 1 WHERE Id_Usuario = '" . $_GET['idUsuario'] . "'";
        //Guardado
    ...
    <body>
        <div class="container">
            ...
            <form name='formulario' id='formulario' method='POST' action=''>
                ...
                <input type="hidden" name="txtUsuario" id="txtUsuario" value="<?php echo $_GET['idUsuario'] ?>">
                <div class="col-12">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4"></div>
                        <!--Mensaje-->
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <p>Ingrese su contraseña actual y la nueva contraseña del usuario <?php echo $_GET['idUsuario']?>.</p>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="d-flex justify-content-center">
                                <button name="btnGuardar" id="btnGuardar" class="btn btn-primary m-5" style="background-color: #3987E3; border-color: #3987E3;" onclick="return validar()">Actualizar</button>
                            </div>
                        </div>
                    </div>
            </form>

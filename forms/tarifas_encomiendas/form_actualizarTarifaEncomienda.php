                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="form-group mt-2 mb-2">
                                ...
                                <textarea rows="4" cols="50" class="form-control" name="txtDescripcion" id="txtDescripcion" readonly><?php echo "" . $descripcion ?></textarea>
                            </div>
                        </div>
                        <!--Pais Origen-->
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <div class="form-group mt-2 mb-2" id="ciudad">
                                ...
                                <select class='form-control' name='cmbCiudadrigen' id='cmbCiudadOrigen' disabled>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            if ($activo == 1) { //Si la tarifa encomienda está como activo en la BD el boton será visible, si no, no
                                ...
                                echo "<button onclick='return validar()' name='btnGuardar' id='btnGuardar' class='btn btn-primary m-5' style='background-color: #3987E3; border-color: #3987E3;'>Activar Encomienda</button>";
                            }
                            ?>

...
include("../../php/tarifas_encomiendas/insertarTarifaEncomienda.php");
...
?>
    ...
    <head>
        ...
        <title>Insertar Tarifa de Encomiendas - KOMing</title>
    ...
    <body>
        <div class="container">
            <div class="col-12 text-center mt-5 mb-5">
                ...
                <h3 style="background-color: #3987E3; color: white;">Insertar Tarifa de Encomiendas</h3>
            </div>
            <form name='formulario' id='formulario' method='POST' action="">
                <input type="hidden" name="accion" id="accion" value="">
                <!--Accion que será cambiada por la funcion validar en tarifasEncomiendas.js-->
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <?php
                        $sql = "SELECT (COUNT(*) + 1) AS C FROM Tarifas_Encomiendas";
                        $noTarifa = 0;
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <div class="form-group mt-2 mb-2">
                                ...
                                <input type="number" class="form-control" name="txtVolumen" id="txtVolumen" placeholder="Ingrese el volumen de la tarifa encomienda"></textarea>
                            </div>
                        </div>
                        <!--Descripcion-->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <div class="form-group mt-2 mb-2">
                                ...
                                <div class="form-inline">
                                    <input type="number" class="form-control" style="max-width: 400px; float: left;" name="txtPorcentaje" id="txtPorcentaje" value="0" min="0" max="100">
                                    <p style="float: left; margin-top: 6px;">%</p>
                                </div>
                            </div>
                        </div>
